...
namespace CabinetStomatologic.Migrations
{
    ...
    [Migration("20240112221354_SpecializariDoctori_Cont")]
    partial class SpecializariDoctori_Cont
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CabinetStomatologic.Models.SpecializariUtil.SpecializariDoctor", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SpecializariDoctor");
                });

            modelBuilder.Entity("CabinetStomatologic.Models.SpecializariUtil.SpecializariDoctor", b =>
                {
                    b.HasOne("CabinetStomatologic.Models.Doctor", "Doctor")
                        .WithMany("SpecializariDoctor")
            ...
            modelBuilder.Entity("CabinetStomatologic.Models.Doctor", b =>
                {
                    b.Navigation("SpecializariDoctor");
                });
